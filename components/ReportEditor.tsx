    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-[#1E293B] pb-3 flex-wrap gap-2">
        <div className="flex items-center gap-2.5">
          ...
          <span className="px-2 py-0.5 rounded-md bg-[#0066FF]/20 text-[#00D2FF] text-[10px] font-bold">
            AI DRAFT v1.0
          </span>
        </div>
      ...
      <div className="space-y-4 overflow-y-auto pr-1 max-h-[440px] custom-scrollbar">
        ...
        >
          <p
            className={`text-[9px] uppercase tracking-widest font-bold mb-1 flex items-center gap-1.5 ${
          ...
          <p className="text-xs font-bold leading-relaxed text-[#E5E7EB]">
            {currentCase.impression}
          </p>
          {currentCase.recommendations && (
            <p className="text-[11px] text-[#94A3B8] mt-1.5">
              <strong className="text-[#E5E7EB]">Рекомендации:</strong> {currentCase.recommendations}
            </p>
          )}
        </section>
      </div>
      ...
      {signatureData.isSigned ? (
        ...
        <div className="flex items-start gap-3 p-3 bg-[#F59E0B]/10 border border-[#F59E0B]/30 rounded-xl">
          ...
          <p className="text-[10px] text-[#F59E0B] leading-snug">
            Черновик сгенерирован ИИ. Требуется проверка и электронная подпись врача.
          </p>
        </div>
      )}
    </motion.div>
